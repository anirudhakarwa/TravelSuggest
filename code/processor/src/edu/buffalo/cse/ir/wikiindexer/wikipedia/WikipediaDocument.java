...
public class WikipediaDocument {
	 ...
	 */
	public WikipediaDocument(int idFromXml, String timestampFromXml, String authorFromXml, String ttl,double latitude, double longitude) throws ParseException {
		this.id = idFromXml;
	 ...
	 */
	protected void addSection(String title, String text,Set<Map<String,String>> templates) {
		sections.add(new Section(title, text,templates));
	}
	...
	public class Section {
		...
		private Section(String parsedTitle, String parsedText,Set<Map<String,String>> templates) {
			this.title = parsedTitle;
			this.text = parsedText;
		...
		public void addTemplates(Map<String,String> templateData)
		{
			templates.add(new Template(templateData));
		}
		...
		public class Template
		{
			...
			public Template(Map<String,String> properties){
